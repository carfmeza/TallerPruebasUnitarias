...
class PruebaOverflowSalary {
	...
	void testCsForOverFlow() {
		Assertions.assertTrue(tester.cs() == Float.MAX_VALUE, "Existe Overflow");
	}

	@Test
	void testCalculateYearBonusOverflow() {
		Assertions.assertTrue(tester.CalculateYearBonus() == Float.MAX_VALUE, "Existe Overflow");
	}
}
